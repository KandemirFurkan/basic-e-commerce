...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$slider->name ?? ''}}" id="name" name="name" placeholder="Slider Başlık">
                  </div>
                  <div class="form-group">
                    <label for="slogan">Slogan</label>
                    <textarea rows="4"   class="form-control" id="slogan" name="content" >{!! $slider->content ?? '' !!}</textarea>
                  </div>
                  <div class="form-group">
                    <label for="link">Link</label>
                    <input type="text" class="form-control" value="{{$slider->seo ?? ''}}" id="link" name="seo" placeholder="Slider Link">
                  </div>
