              ...
              <div class="page">
                <div class="subpage">
                  <div class="header center">
                    <img class="header-img"  src="/img/setting/1729704832_testkey.jpg"/>
                  ...
                  <div class="invoice">
                    ...
                    <div class="font-size-14">
                      <p class="">Sipariş Tarihi : {{ Carbon::parse($invoice->created_at)->format('d-m-Y H:i') ?? ''}}</p>
                      <p>Onay Tarihi: {{ Carbon::parse($invoice->update_at)->format('d-m-Y H:i') ?? ''}}</p>
                    </div>
                  </div>
                </div>

                <div class="content">
                  <h2 class="center font-weight-400">Sipariş Bilgileri</h2>
                  <p class="font-size-14">{{$invoice->phone}}</p>
                  <p class="font-size-14">{{$invoice->address}}</p>
...
@endif
                ...
                <div class="footer"><h3>Toplam : {{$alltotal}} ₺<h3/></div>
                </div>
              </div>
